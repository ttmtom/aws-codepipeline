...
export class PulsePipelineStack extends Stack {
  constructor(scope: Construct, id: string, props: StackProps) {
    ...
    const pr = new PipelineResource(this, PIPELINE_CONFIG.common)
    PIPELINE_CONFIG.deployEnvs.forEach((de) => {
      const pp = new PulsePipeline(this, de, pr, PIPELINE_CONFIG.common)
    })
  }
}
